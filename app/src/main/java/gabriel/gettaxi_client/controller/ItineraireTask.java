...
/**
 * Got this class from the Net.
 * Calculate the route between the destination and the arrival address, and print it in the screen.
 */
public class ItineraireTask extends AsyncTask<Void, Integer, Boolean> {

    private  final String TOAST_MSG;
    private  final String TOAST_ERR_MAJ;
    ...
    public ItineraireTask(final Context context, final GoogleMap gMap, final String editDepart, final String editArrivee) {
        ...
        TOAST_ERR_MAJ = context.getString(R.string.impossibleFindRoute);
        TOAST_MSG = context.getString(R.string.routeCalcul);
    }
    ...
    protected Boolean doInBackground(Void... params) {
        try {
            ...
            url.append("&mode=driving&key=AIzaSyB9v_0lrn3ln_5D9KsblP7Usz0mWxhU2ho");
    ...
    protected void onPostExecute(final Boolean result) {
        if(!result) {
            ...
            gMap.animateCamera(CameraUpdateFactory.newLatLngBounds(latLngBounds, 100));//2nd Param = routePadding
        }
    }
}
